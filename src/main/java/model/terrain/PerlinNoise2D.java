...
public class PerlinNoise2D {
    ...
    public static final int[] p = new int[512], permutation = { 151,160,137,91,90,15,
    ...
    public static void newPermutation() {
    ...
    private static double grad(int hash, double x, double y) {
        switch (hash & 7) {
            ...
            case 2: return x - y;
            case 3: return -x - y;
            case 4: return Math.sqrt(2) * x;
            case 5: return Math.sqrt(2) * y;
            case 6: return -Math.sqrt(2) * x;
            case 7: return -Math.sqrt(2) * y;
            default: return 0;
        }
    }
}